      ...
      <section class="user-panel available-courses">
        ...
        <div class="courses1 py-5">
          ...
          <div class="ten text-white">
            ...
            <TeacherLecturesButton text='ADD QUIZ' href='/teacherquiz' />

            <TeacherLecturesButton text='ADD LECTURE' href='/teacheruploadlecture' />
            ...
            <div class={`row mt-5`}>
              {lecturedata.map((data) => (
                <UserplaycourseLectures path='/teachereditlecture' style='mt-5' />
              ))
              }
